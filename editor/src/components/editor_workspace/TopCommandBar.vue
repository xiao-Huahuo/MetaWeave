...
<template>
  <header class="topbar" :class="{ mobile }">
    ...
    <div class="actions">
      ...
      <button class="github-btn-topbar" :class="{ dark: settingsStore.isDark }" type="button" title="GitHub" @click="workspaceStore.openBrowserSidebar('https://github.com/xiao-Huahuo/MetaWeave')">
